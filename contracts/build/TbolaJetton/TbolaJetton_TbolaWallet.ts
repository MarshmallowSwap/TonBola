...
export function dictValueParserTbolaJetton$Data(): DictionaryValue<TbolaJetton$Data> {
 ...
 type TbolaWallet_init_args = {
    $$type: 'TbolaWallet_init_args';
    owner: Address;
    jetton_master: Address;
}

function initTbolaWallet_init_args(src: TbolaWallet_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.jetton_master);
...
async function TbolaWallet_init(owner: Address, jetton_master: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initTbolaWallet_init_args({ $$type: 'TbolaWallet_init_args', owner, jetton_master })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const TbolaWallet_errors = {
...
export const TbolaWallet_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const TbolaWallet_types: ABIType[] = [
...
const TbolaWallet_getters: ABIGetter[] = [
    {"name":"get_wallet_data","methodId":97026,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
    {"name":"balance","methodId":104128,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"owner","methodId":83229,"arguments":[],"returnType":{"kind":"simple","type":"address","optional":false}},
    {"name":"jetton_master","methodId":70943,"arguments":[],"returnType":{"kind":"simple","type":"address","optional":false}},
]

export const TbolaWallet_getterMapping: { [key: string]: string } = {
    'get_wallet_data': 'getGetWalletData',
    'balance': 'getBalance',
    'owner': 'getOwner',
    'jetton_master': 'getJettonMaster',
}

const TbolaWallet_receivers: ABIReceiver[] = [
...
export class TbolaWallet implements Contract {
    ...
    public static readonly errors = TbolaWallet_errors_backward;
    public static readonly opcodes = TbolaWallet_opcodes;
    
    static async init(owner: Address, jetton_master: Address) {
        return await TbolaWallet_init(owner, jetton_master);
    }
    
    static async fromInit(owner: Address, jetton_master: Address) {
        const __gen_init = await TbolaWallet_init(owner, jetton_master);
        const address = contractAddress(0, __gen_init);
        return new TbolaWallet(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new TbolaWallet(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  TbolaWallet_types,
        getters: TbolaWallet_getters,
        receivers: TbolaWallet_receivers,
        errors: TbolaWallet_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: Transfer | TransferNotification | Burn) {
    ...
    async getJettonMaster(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('jetton_master', builder.build())).stack;
        const result = source.readAddress();
        return result;
    }
